...
**Note:** <br>Say you have a CIDR 24 network with 256 potential IP addresses but only have 6 devices, you could either list each device (host) IP individually if you know them, or tell Nessus to scan your entire CIDR range. The 16 host limit for Nessus essentials only applies to each host discovered during a scan. So I scan my entire network as I know (or think I know) that I have less than 16 hosts (devices).
