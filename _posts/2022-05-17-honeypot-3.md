...
7. How to analyze logs using Kibana > Discover<br>
...
- [CVE-2002-0013](https://www.cvedetails.com/cve-details.php?t=1&cve_id=CVE-2002-0013) [10.0 CVSS] (7 hits): Vulnerable SNMPv1 allows remote attackers to cause a denial of service. 
  **Most Interesting** This is a perfect score CVSS where the exploit impacts the entire CIA (Confidentiality, Integrity, Availability) triad.
