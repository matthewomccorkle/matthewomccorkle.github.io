...
- Top 3 IP Addresses<br>
- Top 5 Countries of Origin<br>
- Top 10 Passwords<br>
- Top 3 Commands<br>
...
10. Mitigating vulnerabilities<br>
"
mathjax: true
layout: post
categories:
...
## Hello and welcome to the NAHB blog post Part 3.
...
9. Something I learned and was not aware of prior to setting up the Honeypot
...
![](C:\Users\matth\AppData\Roaming\marktext\images\2022-05-18-14-44-39-image.png)
...
![](/assets/adbhoney4.PNG)

Next I downloaded the arc file from the IP address above and determined it's file type. ![](/assets/adbhoney5.PNG)
...
# [Continue to Part 4 -->](https://matthewomccorkle.github.io/honeypot-4/)
