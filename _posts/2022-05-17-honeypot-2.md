...
It is a listener! But that does not tell us much. So I input the file URL into VirusTotal so see if anyone had reverse engineered the file. Here are the results:
