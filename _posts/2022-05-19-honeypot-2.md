...
:x:**Disclaimer / Warning: DO NOT DOWNLOAD MALWARE ON YOUR SYSTEMS THESE NEXT STEPS ARE EXTREMELY DANGEROUS**:x:

Next, I gave the x86_64 .elf binary file **777** permissions. <- :x:**AGAIN NEVER DO THIS**.:heavy_exclamation_mark:

Then I executed the malicious file. <- :x:**AGAIN NEVER DO THIS**.:heavy_exclamation_mark:
